        ...
        if(undefined !== window){
            ...
            if(params){
                ...
                json_data.forEach(elt => {
                    console.log(elt.id)
                    if(elt.id == id){
                        setTitle(elt.en_title)
                        setLocker(elt.en_locker)
                        setDescription(elt.en_description)
            ...
            <div className="bg-gray-100 w-full min-h-screen overflow-x-hidden">
                ...
                <div className="w-5/6 mx-auto my-5">
                    ...
                    <div className="lg:grid-cols-2 lg:mt-2 lg:w-3/6 lg:mx-auto">
                        ...
                        {niches.map((niche, i) => (
                            niche.en_title &&
                            <div key={i} onClick={e => {choose_niche(e);setLoading(true)}} className={` ${search !== '' && !niche.en_keywords.includes(search.toLowerCase()) && 'hidden'} w-full bg-gray-50 rounded-xl shadow-lg mt-7 relative py-8 cursor-pointer `}>
                                <div className="locker hidden">{niche.en_locker}</div>
                                <div className='flex gap-3 px-3'>
                                    <div className="relative w-32 text-center justify-center align-middle items-center">
                                        <div className="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 w-5/6 md:w-4/6">
                                    ...
                                    <div>
                                        <h1 className="font-bold text-gray-600 text-xl py-2">{niche.en_title}</h1>
                                    </div>
                                </div>
                                <center>
