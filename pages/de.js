...
const DE = () => {
        ...
        if(undefined !== window){
            ...
            if(params){
                ...
                json_data.forEach(elt => {
                    console.log(elt.id)
                    if(elt.id == id){
                        setTitle(elt.de_title)
                        setLocker(elt.de_locker)
                        setDescription(elt.de_description)
    ...
    useEffect(() => {
        if(loading){
            ...
            setProgressText(title + 'wird geladen...')
            setTimeout(() => {
                setProgressText(title + '.zip auspacken...')
            }, 8000)
            setTimeout(() => {
                setProgressText('Hochladen der App auf Ihr Gerät...')
            }, 16000)
    ...
    return (
        ...
        <div className="bg-slate-100 w-full min-h-screen overflow-x-hidden">
            ...
            {/* H T M L   H E A D */}
            <Head>
                <title>{lp_name} - Optimierte und kostenlose Premium-Apps, Jailbreak und vieles mehr...</title>
            ...
            <div className="w-full shadow-md text-center text-white bg-red-500 py-4 px-5">
                ...
                <p className="animate__animated animate__backInLeft text-sm">Optimierte und kostenlose Premium-Apps, Jailbreak und vieles mehr...</p>
            </div>
            ...
            {step_2 && 
                <>
                    ...
                    <div className="w-5/6 md:w-2/6 bg-gray-200 rounded-xl shadow-lg py-8 text-center fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 z-50 animate__animated animate__fadeIn">
                        ...
                        {!loading ?
                            <>
                            <h1 className="text-red-500 font-bold text-xl">Download bereit</h1>
                            <p className="px-6 text-gray-600">Klicken Sie auf die Schaltfläche unten, um mit dem Download Ihrer App zu beginnen.</p>
                            <button onClick={e => setLoading(true)} className="mt-4 py-4 px-8 bg-red-500 rounded-xl shadow-lg font-bold text-white animate__animated animate__pulse animate__infinite">JETZT DOWNLOADEN</button>
                            </>
                            :
                            <> 
            ...
            <div className="w-5/6 mx-auto my-4">
                ...
                <div className="relative text-center md:w-2/6 mx-auto animate__animated animate__pulse animate__infinite">
                    ...
                    <input onChange={e => setSearch(e.target.value)} type="text" className="w-full mx-auto bg-gray-300 rounded-xl shadow-sm py-3 text-gray-200 text-lg text-center" placeholder="Apps suchen..."/>
                </div>
                ...
                <div className="grid gap-3 grid-cols-1 lg:grid-cols-2 lg:mt-2 lg:w-3/6 lg:mx-auto">
                    ...
                    {niches.map((niche, i) => (
                        niche.de_title &&
                        <div key={i} onClick={e => choose_niche(e)} className={`${search !== '' && !niche.de_keywords.includes(search.toLowerCase()) && 'hidden'} w-full bg-gray-50 rounded-xl shadow-lg mt-4 md:my-2 relative py-8 cursor-pointer `}>
                            <div className="locker hidden">{niche.de_locker}</div>
                            ...
                            <div className='flex gap-3 px-3'>
                                ...
                                <div>
                                    ...
                                    <h1 className="font-bold text-gray-600 text-2xl">{niche.de_title}</h1>
                                    <p className="text-gray-400 text-sm description">{niche.de_description}</p>
                                    <div className='flex'>
            ...
            <div className="bg-gray-100 w-full min-h-screen overflow-x-hidden">
                    ...
                    <>
                        ...
                        <div className="w-5/6 md:w-2/6 bg-gray-200 rounded-xl shadow-lg py-8 text-center fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 z-50 animate__animated animate__fadeIn">
                            ...
                            {!loading ?
                                ...
                                <p className="px-6 text-gray-600">Click on Download to start downloading the application to your device </p>
                ...
                <div className="w-5/6 mx-auto my-5">
                    ...
                    <div className="lg:grid-cols-2 lg:mt-2 lg:w-3/6 lg:mx-auto">
                        ...
                        {niches.map((niche, i) => (
                            niche.de_title &&
                            <div key={i} onClick={e => {choose_niche(e);setLoading(true)}} className={` ${search !== '' && !niche.de_keywords.includes(search.toLowerCase()) && 'hidden'} w-full bg-gray-50 rounded-xl shadow-lg mt-7 relative py-8 cursor-pointer `}>
                                <div className="locker hidden">{niche.de_locker}</div>
                                <div className='flex gap-3 px-3'>
                                    <div className="relative w-32 text-center justify-center align-middle items-center">
                                        <div className="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 w-5/6 md:w-4/6">
                                    ...
                                    <div>
                                        <h1 className="font-bold text-gray-600 text-xl py-2">{niche.de_title}</h1>
                                    </div>
                                </div>
                                <center>
